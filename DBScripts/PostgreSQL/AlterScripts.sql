...
alter table hms.inbox add role_id int4 references hms.roles(role_id);
update hms.inbox set role_id  =1;
ALTER TABLE hms.inbox ALTER COLUMN role_id SET NOT NULL;
