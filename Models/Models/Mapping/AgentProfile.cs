    ...
    public class AgentProfile : Profile
    {
        public AgentProfile()
        {
            CreateMap<Agent, AgentDto>()
                ...
                .ForMember(dest => dest.Ic36TrngCompletionDate, opt => opt.Ignore())
                .ForMember(dest => dest.STrngCompletionDate, opt => opt.Ignore())
                .ForMember(dest => dest.FgRockstarTrainingDate, opt => opt.Ignore())
                .ForMember(dest => dest.FgValueTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.HSecPolicyTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.ItSecPolicyTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.NpsTrngCompletionDate, opt => opt.Ignore())
                .ForMember(dest => dest.WhistleBlowerTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.GovPolicyTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.InductionTrngDate, opt => opt.Ignore())
                .ForMember(dest => dest.ConfirmationDate, opt => opt.Ignore())
                .ForMember(dest => dest.IncrementDate, opt => opt.Ignore())
                .ForMember(dest => dest.LastPromotionDate, opt => opt.Ignore())
                .ForMember(dest => dest.HRDoj, opt => opt.Ignore())
                .ForMember(dest => dest.LastWorkingDate, opt => opt.Ignore())
                .ForMember(dest => dest.LicenseNo, opt => opt.Ignore())
                .ForMember(dest => dest.LicenseType, opt => opt.Ignore())
                .ForMember(dest => dest.LicenseIssueDate, opt => opt.Ignore())
                .ForMember(dest => dest.LicenseExpiryDate, opt => opt.Ignore())
